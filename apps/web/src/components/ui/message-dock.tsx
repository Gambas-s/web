...
/* ─────────────────────────────────────────────────
   Design system tokens (kept in sync with tokens.ts)
   ───────────────────────────────────────────────── */
const DS = {
  /** 영역 구분 stroke — neutral-200 */
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Online indicator — success token */}
                  {character.online && (
                    <motion.div
                      className="absolute bottom-0 right-0 w-3 h-3 border-2 border-white rounded-full"
                      style={{ background: DS.online }}
                      initial={{ scale: 0 }}
          ...
          <AnimatePresence>
            {isExpanded && (
              <motion.input
                ...
                className="w-[300px] absolute left-14 right-0 bg-transparent border-none outline-none text-sm font-medium z-50"
                style={{
                  color: textColor,
